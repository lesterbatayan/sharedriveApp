    ...
    <div class="grid py-4 px-4 lg:px-8 relative" id="hero">
      <div class="mx-4 md:mx-8 mt-0 md:mt-4">
        ...
        <p class="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">
          Sed blandit libero volutpat sed cras. Fames ac turpis egestas integer. Placerat
          in egestas erat...
        </p>
        <Button
          label="Get Started"
      ...
      <div class="grid mt-8 pb-2 md:pb-8">
        ...
        >
          ...
          <span
            ...
            >Lectus arcu bibendum at varius vel pharetra vel turpis nunc. Eget aliquet
            nibh praesent tristique magna sit amet purus gravida. Sit amet mattis
      ...
      <div class="grid my-8 pt-2 md:pt-8">
        ...
        >
          ...
          <span
            ...
            nunc sed blandit libero. Suspendisse in est ante in. Mauris pharetra et
